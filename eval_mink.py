...
# fig.subplots_adjust(
#     left=0.2,   # Increase to move the left margin to the right
#     right=0.8,  # Decrease to move the right margin to the left
#     top=0.8,    # Decrease to move the top margin down
#     bottom=0.2  # Increase to move the bottom margin up
# )
...
ax1.plot(
    ...
    color="tab:orange",
    linestyle="--",
    label="Normalized Ratio Mink Unlearning/Reference",
    linewidth=3,
)
...
ax2 = ax1.twinx()
color = "tab:blue"
ax2.set_ylabel("Safety Eval (clipped 0.7-0.9)", color=color, labelpad=10)
ax2.plot(
